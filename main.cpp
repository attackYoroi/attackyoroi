...
uint8_t Tbox3_recovered[256] = { 0 };
uint8_t Tbox4_recovered[256] = { 0 };
...
uint8_t Tbox3_recovered_inv[256] = { 0 };
uint8_t Tbox4_recovered_inv[256] = { 0 };
...
void GetGoodPairs_ThirdRound() {
	...
	for (int i = 0; i < 32; i++) {
		...
		//goodpairs[i][0] = yoroi_inverse(ciphertext1);
		//goodpairs[i][1] = yoroi_inverse(ciphertext2);
		cout << std::hex << "0x" << RecoveredSecondRound(RecoveredFirstRound(yoroi_inverse(ciphertext1))) << ",0x" << RecoveredFirstRound(RecoveredFirstRound(yoroi_inverse(ciphertext2))) << "," << endl;
	}
...
uint32_t goodpairs_thirdround[32][2] = { 0x12342a53,0x979b7019,
0xc42e5c7c,0x2c258ff7,
0x22d917cb,0xef483a0a,
0x2aaab7e5,0x84a980af,
0x3c72d20d,0x4d37c3bd,
0xde1d8771,0x599c3e46,
0x9b05cba8,0xb8baf06b,
0xfabce80d,0xf95cfa2f,
0x6961f91f,0xf2975f51,
0x43c0bd10,0x51379205,
0xf653bfae,0x2b5c3d1a,
0x12411af3,0x7d051967,
0xdff95b5a,0x46e00974,
0xc3851807,0xbf49a901,
0x32442378,0xf20be898,
0x9158273a,0x789814ae,
0x8f701286,0xc0cc0e56,
0x37d03ed,0x7e928990,
0x9ee5b165,0x5479fc9b,
0xff1863a5,0x9025be17,
0x1c64774e,0x37a38284,
0x98d5150f,0x748e9981,
0x6f368db4,0x63b177d,
0x7a48d47a,0x78efee18,
0xa67876c6,0x543bd6b6,
0x6b9323ac,0x901ced52,
0x96ac3498,0x490b33e6,
0xfa053e0d,0xed2dc716,
0xa17dba0b,0x75c60d1d,
0x9c74370e,0x2816ef73,
0xe841c4c,0xeedfa668,
0x99700eac,0xcc08ad9b, };
uint8_t Ai_thirdround[8][32] = {};
uint32_t possible_right_paris_thirdround[20][2] = {};
uint32_t right_pairs_thirdround[4][2] = {};
